...
srf_arg:
	...
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_3.srf arg.crg 0 2.0 .45 1 1 0 .
	...
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_5.srf arg.crg 0 2.0 .6 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_6.srf arg.crg 0 2.0 .7 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_7.srf arg.crg 0 2.0 .8 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_8.srf arg.crg 0 2.0 1 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_9.srf arg.crg 0 2.0 1.25 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_10.srf arg.crg 0 2.0 1.5 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_11.srf arg.crg 0 2.0 2 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_12.srf arg.crg 0 2.0 3 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_13.srf arg.crg 0 2.0 4 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_14.srf arg.crg 0 2.0 5 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_15.srf arg.crg 0 2.0 6 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_16.srf arg.crg 0 2.0 7 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_17.srf arg.crg 0 2.0 8 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_18.srf arg.crg 0 2.0 12 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_19.srf arg.crg 0 2.0 16 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_20.srf arg.crg 0 2.0 20 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_21.srf arg.crg 0 2.0 24 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_22.srf arg.crg 0 2.0 28 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_23.srf arg.crg 0 2.0 32 1 1 0 .
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker arg.pdb scaled_charmm22.siz charmm.crg arg_scaledcharmm_24.srf arg.crg 0 2.0 50 1 1 0 .
...
srf_2rh3:
	cd geometry; MSMS_PATH=${MSMS_PATH} ../bin/meshmaker 2rh3.pdb charmm.siz charmm.crg 2rh3_scaledcharmm_1.srf 2rh3.crg 0 2.0 3.1 1 1 0 .
