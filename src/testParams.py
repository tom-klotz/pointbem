...
regressionParameters = {os.environ["PETSC_TO_POINTBEM"]+'/src/testSrfOnSurfacePoints':
                            [# Sphere tests [sphere_0-sphere_10]
                             {'num': 'sphere_0',  'numProcs': 1, 'args': '-srf_base ../geometry/sphere_R6_vdens0 -num_charges 10 -nmax 25 -srf_num 0125 -density 0.125 -ksp_rtol 1.0e-10 -snes_linesearch_type basic -snes_type ksponly -ksp_rtol 1e-6'},
